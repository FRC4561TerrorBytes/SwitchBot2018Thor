...
public class ArmPID extends Subsystem {
	...
	public ArmPID() {
		motorOne = new WPI_TalonSRX(frc.robot.RobotMap.ARM_MOTOR_1_PORT);
	...
	public void IntakePosition() {
		goal = -1560;
		if (frc.robot.RobotMap.ARM_PID) setToGoal();
		if (frc.robot.RobotMap.ARM_DEBUG) {
